 ...
 */
package com.krishnaweb.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(KrishnawebFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(KrishnawebFulfilmentProcessConstants.PARENT_PROCESS);
