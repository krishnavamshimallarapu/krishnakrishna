...
import com.krishnaweb.storefront.controllers.ControllerConstants;
import com.krishnaweb.storefront.registrationform.address.AddressRegistraerForm;
...
public class LoginPageController extends AbstractLoginPageController
{
	...
	public String doRegister(@RequestHeader(value = "referer", required = false) final String referer,
			final AddressRegistraerForm form, final BindingResult bindingResult, final Model model, final HttpServletRequest request,
	...
	protected String processRegisterUserRequest(final String referer, final AddressRegistraerForm form,
			final BindingResult bindingResult, final Model model, final HttpServletRequest request,
			final HttpServletResponse response, final RedirectAttributes redirectModel) throws CMSItemNotFoundException
	{
		if (bindingResult.hasErrors())
		{
			model.addAttribute("addressRegistraerForm", form);
		...
		try
		{
			//Here control is moving to Facade layer.
	...
	//Over riding the getDefaultLoginPage Method
	@Override
			...
			throws CMSItemNotFoundException
	{
		...
		final AddressRegistraerForm addressRegistraerForm = new AddressRegistraerForm();
		model.addAttribute("addressRegistraerForm", addressRegistraerForm);
		model.addAttribute(new GuestForm());
