...
<form:form method="post" commandName="addressRegistraerForm"
	action="${action}">
	...
	<formElement:formInputBox idKey="register.lastName"
		...
		mandatory="true" />
	<formElement:formInputBox idKey="register.mobileno"
		labelKey="register.mobileno" path="mobileNumber"
		inputCSS="form-control" mandatory="true" />
	<formElement:formInputBox idKey="register.addr1"
		labelKey="register.addr1" path="line1" inputCSS="form-control"
		mandatory="true" />
	<formElement:formInputBox idKey="register.addr2"
		labelKey="register.addr2" path="line2" inputCSS="form-control"
		mandatory="true" />
	...
	<formElement:formSelectBox idKey="register.countryIso"
		...
		skipBlank="false" skipBlankMessageKey="Country" items="${countries}"
		itemValue="isocode" selectCSSClass="form-control" />
	<formElement:formInputBox idKey="register.postalCode"
		labelKey="register.postalCode" path="postalCode"
		inputCSS="form-control" mandatory="true" />
