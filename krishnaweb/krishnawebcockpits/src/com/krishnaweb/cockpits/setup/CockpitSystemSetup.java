 ...
 */
package com.krishnaweb.cockpits.setup;
...
import com.krishnaweb.cockpits.constants.KrishnawebCockpitsConstants;
 ...
 */
@SystemSetup(extension = KrishnawebCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(KrishnawebCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(KrishnawebCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						KrishnawebCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/krishnawebcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
