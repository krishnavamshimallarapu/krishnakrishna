 ...
 */
package com.krishnaweb.test.setup;
...
import com.krishnaweb.test.constants.KrishnawebTestConstants;
import com.krishnaweb.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = KrishnawebTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/krishnawebtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/krishnawebtest/import/reviews.impex");
			...
			importImpexFile(context, "/krishnawebtest/import/cstickets.impex");
		}
	}
}
